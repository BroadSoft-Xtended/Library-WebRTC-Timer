...
styles/css: $(STYLUS_FILES)
	stylus --include-css styles/timer.styl -o styles

styles/min.css: styles/css
	cssmin styles/*.css > styles/timer.min.css

node_modules/bdsft-webrtc-styles.js: styles/min.css
	node_modules/webrtc-core/scripts/export-style styles/timer.min.css node_modules/bdsft-webrtc-styles.js
